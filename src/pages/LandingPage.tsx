...
const faqItems = [
  ...
  { q: "E se eu quiser cancelar?", a: "Você pode cancelar a qualquer momento, sem multa ou burocracia. Nos primeiros 15 dias, é totalmente grátis." },
      ...
      <section className="relative overflow-hidden px-4 py-20 md:py-32">
        ...
        <div className="relative mx-auto max-w-4xl text-center">
          ...
          <Badge className="mb-6 border-[hsl(217,91%,60%)]/30 bg-[hsl(217,91%,60%)]/10 text-[hsl(217,91%,60%)] hover:bg-[hsl(217,91%,60%)]/20">
            <Zap className="mr-1 h-3 w-3" /> 15 dias grátis — sem cartão de crédito
          </Badge>
          ...
          <p className="mx-auto mb-8 max-w-2xl text-lg text-white md:text-xl">
           ...
           <div className="flex flex-col items-center gap-4 sm:flex-row sm:justify-center">
             <Button size="lg" asChild className="h-14 px-6 sm:px-8 text-base bg-[hsl(217,91%,60%)] hover:bg-[hsl(217,91%,50%)] w-full sm:w-auto">
               <Link to="/register">
                 Comece Seu Teste Grátis de 15 Dias <ArrowRight className="ml-2 h-5 w-5" />
               </Link>
             </Button>
           </div>
            ...
            <CardContent className="p-8 pt-12">
              ...
              <ul className="mb-8 space-y-3">
               ...
               <Button size="lg" asChild className="w-full h-14 text-base bg-[hsl(217,91%,60%)] hover:bg-[hsl(217,91%,50%)]">
                 <Link to="/register">
                   Começar Agora — 15 Dias Grátis <ArrowRight className="ml-2 h-5 w-5" />
                 </Link>
               </Button>
